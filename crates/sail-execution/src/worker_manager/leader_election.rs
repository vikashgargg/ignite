...
impl Default for LeaderElectionConfig {
    fn default() -> Self {
        Self {
            lease_name: "vajra-scheduler-leader".to_string(),
            namespace: "vajra".to_string(),
            identity: std::env::var("HOSTNAME").unwrap_or_else(|_| "vajra-server".to_string()),
            ...
            Some(existing) => {
                ...
                match self
                    ...
                    .patch(
                        ...
                        &PatchParams::apply("vajra-leader-elector"),
