...
use sail_physical_plan::streaming::exchange::merge_flow_event_streams;
...
async fn shuffle_read(
    ...
    // streaming stage-boundary cut (VAJRA_DISTRIBUTED_STREAM) reach this branch, so batch is untouched.
