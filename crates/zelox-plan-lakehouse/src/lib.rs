...
use zelox_data_source::resolve_listing_urls;
use zelox_delta_lake::table::open_table_with_object_store_and_table_config;
use zelox_delta_lake::DeltaSnapshotConfig;
use zelox_logical_plan::file_delete::FileDeleteNode;
use zelox_logical_plan::file_write::FileWriteNode;
use zelox_logical_plan::merge::{MergeCardinalityCheckNode, RowLevelWriteNode};
...
use zelox_physical_plan::row_level_write::create_row_level_write_physical_plan;
use url::Url;

mod optimizer;

pub use optimizer::{lakehouse_optimizer_rules, ExpandRowLevelOp};
use zelox_common_datafusion::datasource::is_lakehouse_format;
...
pub fn new_lakehouse_extension_planners() -> Vec<Arc<dyn ExtensionPlanner + Send + Sync>> {
    vec![
        Arc::new(zelox_delta_lake::planner::DeltaTablePhysicalPlanner),
        Arc::new(zelox_iceberg::IcebergTablePhysicalPlanner),
