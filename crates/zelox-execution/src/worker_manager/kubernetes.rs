...
use rand::RngExt;
use zelox_common::config::ClusterConfigEnv;
use zelox_server::RetryStrategy;
use zelox_telemetry::common::ContextPropagationEnv;
...
impl KubernetesWorkerManager {
    ...
    fn build_pod_labels(&self, id: WorkerId) -> BTreeMap<String, String> {
        BTreeMap::from([
            ("app.kubernetes.io/name".to_string(), "zelox".to_string()),
            (
    ...
    async fn launch_worker(
        ...
        let mut spec = PodSpec {
            containers: vec![Container {
                ...
                command: Some(vec!["zelox".to_string()]),
