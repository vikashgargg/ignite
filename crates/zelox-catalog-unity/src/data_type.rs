    ...
    match type_field.as_str() {
        ...
        "array" => {
            ...
            Ok(DataType::List(Arc::new(
                Field::new(ZELOX_LIST_FIELD_NAME, element_type, contains_null)
                ...
                Arc::new(
                    Field::new(
                        ...
                        DataType::Struct(Fields::from(vec![
                            Field::new(ZELOX_MAP_KEY_FIELD_NAME, key_type, false),
                            Field::new(ZELOX_MAP_VALUE_FIELD_NAME, value_type, value_contains_null),
                        ])),
                        false,
                    )
                    .with_metadata(metadata),
