...
enum StreamDriver {
    ...
    /// `Trigger.Continuous` (Zelox realtime mode): one long-lived unbounded pipeline that flows
...
/// commit record (`zelox_data_source::formats::file_stream::current_batch_id`), which advances
    ...
    async fn run(
        ...
        match driver {
            ...
            StreamDriver::Realtime {
                ...
                // Zelox realtime mode: one long-lived unbounded pipeline. Records flow continuously
