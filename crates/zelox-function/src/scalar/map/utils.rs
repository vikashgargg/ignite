...
use zelox_common::spec::{ZELOX_MAP_FIELD_NAME, ZELOX_MAP_KEY_FIELD_NAME, ZELOX_MAP_VALUE_FIELD_NAME};
    ...
    DataType::Map(
        Arc::new(Field::new(
            ...
            DataType::Struct(Fields::from(vec![
                ...
                Field::new(ZELOX_MAP_KEY_FIELD_NAME, key_type.clone(), false),
                Field::new(ZELOX_MAP_VALUE_FIELD_NAME, value_type.clone(), true),
            ])),
