...
pub use zelox_common_datafusion::catalog::{CatalogPartitionField, PartitionTransform};
...
pub struct CreateTableOptions {
    ...
    pub location: Option<String>,
    /// `true` if LOCATION was explicitly specified (EXTERNAL table).
    /// `false` if location was auto-generated by the warehouse path (MANAGED table).
