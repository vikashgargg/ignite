...
pub const COL_REPLAY_PATH: &str = "__zelox_delta_replay_path";
...
pub const COL_LOG_IS_REMOVE: &str = "__zelox_delta_is_remove";
...
pub const COL_LOG_VERSION: &str = "__zelox_delta_log_version";
