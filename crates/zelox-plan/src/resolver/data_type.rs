...
use zelox_common::spark::extension::{
        ...
        match data_type {
            ...
            DataType::List {
                ...
                let field = spec::Field {
                    name: ZELOX_LIST_FIELD_NAME.to_string(),
            ...
            DataType::Map {
                ...
                let fields = spec::Fields::from(vec![
                    spec::Field {
                        name: ZELOX_MAP_KEY_FIELD_NAME.to_string(),
                        data_type: *key_type.clone(),
                        nullable: false,
                        metadata: vec![],
                    },
                    spec::Field {
                        name: ZELOX_MAP_VALUE_FIELD_NAME.to_string(),
    ...
    pub(super) fn resolve_field(
        ...
        let data_type = match data_type {
            spec::DataType::UserDefined {
                ...
                metadata.insert(
                    spec::ZELOX_SPARK_UDT_METADATA_KEY.to_string(),
