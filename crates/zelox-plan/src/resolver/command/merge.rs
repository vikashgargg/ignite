...
use zelox_common_datafusion::column_features::ColumnFeatures;
use zelox_common_datafusion::datasource::OptionLayer;
use zelox_common_datafusion::extension::SessionExtensionAccessor;
use zelox_common_datafusion::logical_expr::ExprWithSource;
use zelox_logical_plan::merge::{
...
fn parse_gen_expr(gen_expr_str: &str) -> PlanResult<spec::Expr> {
    let ast_expr = zelox_sql_analyzer::parser::parse_expression(gen_expr_str).map_err(|e| {
