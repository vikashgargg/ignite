...
use zelox_common_datafusion::rename::table_provider::RenameTableProvider;
use zelox_common_datafusion::streaming::event::schema::try_from_flow_event_schema;
use zelox_common_datafusion::streaming::event::schema::{
    is_flow_event_schema, MARKER_FIELD_NAME, RETRACTED_FIELD_NAME,
};
use zelox_common_datafusion::streaming::source::{StreamSource, StreamSourceTableProvider};
...
impl StreamingRewriter {
    fn f_up_extension(&mut self, extension: Extension) -> Result<Transformed<LogicalPlan>> {
        ...
        } else if node.as_any().is::<zelox_logical_plan::repartition::ExplicitRepartitionNode>() {
                    ...
                    return Ok(Transformed::yes(LogicalPlan::Extension(Extension {
                        node: Arc::new(WindowAccumNode::new(
                            ...
                            Arc::new(datafusion_common::DFSchema::try_from(
                                std::sync::Arc::new(
                                    zelox_common_datafusion::streaming::event::schema::to_flow_event_schema(
