...
use zelox_function::aggregate::sketch::{Int64AggStub, SketchAggStub};
use zelox_function::aggregate::skewness::SkewnessFunc;
use zelox_function::aggregate::try_avg::TryAvgFunction;
use zelox_function::window::spark_ntile_udwf;
...
fn list_built_in_window_functions() -> Vec<(&'static str, WinFunction)> {
    ...
    vec![
        ...
        (
            "count_min_sketch",
            F::aggregate(|| Arc::new(AggregateUDF::from(SketchAggStub::new("count_min_sketch")))),
        ),
        ...
        (
            "grouping_id",
            F::aggregate(|| Arc::new(AggregateUDF::from(Int64AggStub::new("grouping_id")))),
        ),
        (
            "histogram_numeric",
        ...
        (
            "hll_sketch_agg",
            F::aggregate(|| Arc::new(AggregateUDF::from(SketchAggStub::new("hll_sketch_agg")))),
        ),
        (
            "hll_union_agg",
            F::aggregate(|| Arc::new(AggregateUDF::from(SketchAggStub::new("hll_union_agg")))),
        ),
