//! Streaming file-sink commit log — Zelox's implementation of Spark's `_spark_metadata`.
//!
...
//!
//! Zelox layout (chosen to scale past Spark's per-trigger full-dir listing): each micro-batch
