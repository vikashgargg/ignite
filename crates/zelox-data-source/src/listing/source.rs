...
impl<T: FormatFactory> TableFormat for ListingTableFormat<T> {
    ...
    async fn create_source(
        ...
        if is_streaming {
            ...
            return Ok(provider_as_source(Arc::new(
                zelox_common_datafusion::streaming::source::StreamSourceTableProvider::new(
    ...
    async fn create_writer(
        ...
        let commit_log_checkpoint = zelox_common_datafusion::datasource::take_option(
            &mut options,
        ...
        let realtime_interval = zelox_common_datafusion::datasource::take_option(
            &mut options,
            zelox_common_datafusion::datasource::STREAM_REALTIME_INTERVAL_OPTION,
        );
