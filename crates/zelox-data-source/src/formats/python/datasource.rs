...
impl PythonDataSource {
    ...
    fn parse_ddl_schema(ddl: &str) -> Result<SchemaRef> {
        ...
        let ast = zelox_parser::parse_data_type(&type_str).map_err(|e| {
...
fn spec_data_type_to_arrow(dt: &zelox_common::spec::DataType) -> Result<arrow_schema::DataType> {
    use arrow_schema::{DataType, TimeUnit};
    use zelox_common::spec::DataType as SDT;
