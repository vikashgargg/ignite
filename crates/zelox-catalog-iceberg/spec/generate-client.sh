...
rm -rf crates/zelox-catalog-iceberg/src/generated_rest_temp

openapi-generator generate \
  --generator-name rust \
  --config crates/zelox-catalog-iceberg/spec/openapi-generator-config.yaml \
...
rm -rf crates/zelox-catalog-iceberg/src/apis
rm -rf crates/zelox-catalog-iceberg/src/models
cp -r crates/zelox-catalog-iceberg/src/generated_rest_temp/src/apis crates/zelox-catalog-iceberg/src/
cp -r crates/zelox-catalog-iceberg/src/generated_rest_temp/src/models crates/zelox-catalog-iceberg/src/
