...
pub const ZELOX_LIST_FIELD_NAME: &str = "item";
/// Field name for map type's entries.
pub const ZELOX_MAP_FIELD_NAME: &str = "entries";
/// Field name for map type's key.
pub const ZELOX_MAP_KEY_FIELD_NAME: &str = "key";
/// Field name for map type's value.
pub const ZELOX_MAP_VALUE_FIELD_NAME: &str = "value";
