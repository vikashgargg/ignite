...
from pyzelox.testing.spark.utils.sql import escape_sql_string_literal
...
class TestListTables:
    ...
    def test_persistent_table_defaults_to_managed(self, spark):
        """Persistent tables without LOCATION default to MANAGED in catalog surfaces."""
        table_name = "test_managed_default"
        try:
