...
def pytest_configure(config):
    ...
    config.pluginmanager.import_plugin("pyzelox.testing.spark.steps.file_tree")
    config.pluginmanager.import_plugin("pyzelox.testing.spark.steps.sql")
    config.pluginmanager.import_plugin("pyzelox.testing.spark.steps.plan")
    config.pluginmanager.import_plugin("pyzelox.testing.spark.steps.delta_log")
    config.pluginmanager.import_plugin("pyzelox.testing.spark.steps.iceberg_metadata")
