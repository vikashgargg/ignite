...
Zelox supports a wide range of built-in Spark functions and operators that can be used in your data processing tasks.
...
the [Zelox GitHub repository](https://github.com/lakehq/sail).
