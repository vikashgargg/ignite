...
It optionally supports Arrow for zero-copy data exchange between the Python process and the Zelox execution engine. This gives you flexibility in data source implementations without incurring performance penalties.
...
Currently, Zelox supports Python data sources for batch reading and writing.
...
<<< @/../python/pyzelox/tests/spark/datasource/test_python_read.txt{python-console}

### Batch Arrow Reader

<<< @/../python/pyzelox/tests/spark/datasource/test_python_read_arrow.txt{python-console}
