...
| **Throughput** | Arrow columnar; Leis et al. *Morsel-Driven Parallelism* (SIGMOD 2014); Arrow Flight zero-copy shuffle; DataFusion vectorized agg | Vectorized batch ops, morsel/NUMA-parallel operators, zero-copy shuffle, parallel parse | ❌ ~2.4× Flink gap (single-instance from_json/exchange/window) — capstone plan |
